...
The null hypothesis for the variances test is that the two variance are equal. The result shows that the p-value is much less than 0.05. Thus, we may reject the null hypothesis and conclude that the variances are not equal. Next, we should perform 2 sample t.test with unknown and unequal variance.
...
* It is clearly shown in the plot that Northeast region has a much lower and South region has a much higher average Alzheimer's Disease death rate than the other regions.
...
* The pattern is clear that low employment tends to a higher Alzheimer's Disease death rate. 
