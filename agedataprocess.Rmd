...
write.csv(data_2021, file = "result_2021.csv", row.names = FALSE)

data_2019 <- process_data("../Data/age_over_65/2019.csv")
write.csv(data_2019, file = "result_2019.csv", row.names = FALSE)

data_2018 <- process_data("../Data/age_over_65/2018.csv")
write.csv(data_2018, file = "result_2018.csv", row.names = FALSE)
